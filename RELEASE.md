...
5. The release job re-verifies all four exact Core source contracts (including source-backed 0.1.5 handle regressions), browser regression and committed bundle, packs the artifact and generates/validates `SHA256SUMS`.
