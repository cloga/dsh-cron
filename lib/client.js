...
function openDrawer(tab, sessionId = activeSessionId) {
	...
	try {
		if (sidebar?.isTabEnabled("dsh-cron:tasks") && sidebar.getSnapshot().sessionId === sessionId) {
...
function EditTaskForm({ t, task, sessionId, onDone }) {
...
function CronPanel({ t, tab, sessionId, visible }) {
	...
	const live = (0, react.useRef)(false);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [error ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: styles.error,
		children: error
...
function PanelSettings({ t, sessionId, visible, embedded }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
			...
			children: [
				embedded ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
function PanelContent({ t, sessionId, visible, onClose }) {
	useDrawerState();
	const view = sessionView(sessionId);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		onClose ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PanelHeader, {
			t,
			onClose
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: styles.owner,
...
function StandalonePanel({ t, sessionId, children }) {
	const ref = (0, react.useRef)(null);
	(0, react.useEffect)(() => {
...
function CronDrawer({ t }) {
	...
	return (0, react_dom.createPortal)(open && owner ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StandalonePanel, {
		t: tr,
		sessionId: owner,
...
function CronAction({ t, sessionId }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		children: compact ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
			width: "16",
			height: "16",
			viewBox: "0 0 24 24",
			fill: "none",
